...
public sealed class SettingsWindow : Window
{
    ...
    private readonly TextBox unlockMinutesBox = new()
    {
        Header = "\uC784\uC2DC \uD574\uC81C \uC720\uC9C0 \uC2DC\uAC04(\uBD84)",
        Width = 240,
    ...
    private FrameworkElement BuildGeneralSection()
    {
        ...
        numberPanel.ColumnDefinitions.Add(new ColumnDefinition { Width = GridLength.Auto });
        Grid.SetColumn(unlockMinutesBox, 0);
        Grid.SetColumn(authCacheMinutesBox, 1);
        numberPanel.Children.Add(unlockMinutesBox);
    ...
    private void LoadPreferenceValues()
    {
        ...
        unlockMinutesBox.Text = ViewModel.UnlockMinutes.ToString();
    ...
    private async void SaveButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        if (ViewModel.CanSaveHotkeys)
        {
            await ViewModel.SavePreferencesAsync(
                ...
                CoerceMinutesText(unlockMinutesBox.Text, ViewModel.UnlockMinutes),
