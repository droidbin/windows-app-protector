...
public sealed class MainWindow : Window
{
    ...
    private readonly AppBarButton lockNowButton = new() { Label = "\uC7A0\uAE08 \uC801\uC6A9" };
    ...
    private FrameworkElement BuildContent()
    {
        ...
        lockNowButton.Click += LockNowButton_Click;
        ...
        commandBar.PrimaryCommands.Add(lockNowButton);
        ...
        toolbar.Children.Add(CreateButton("\uC784\uC2DC \uD574\uC81C", TemporaryUnlock_Click));
    ...
    private async void TemporaryUnlock_Click(object sender, RoutedEventArgs e)
    {
        await ViewModel.TemporaryUnlockAsync();
    }
